...
_VIEWER_STYLE = b'<link rel="stylesheet" href="/static/viewer_vehicle_enhancements.css?v=0.19.8">'
_VIEWER_SCRIPT = b'<script src="/static/viewer_vehicle_enhancements.js?v=0.19.8"></script>'
